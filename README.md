...
Then on the GitHub website create a new release using the tag generated by bump-my-version. This release will trigger a GitHub action to build and upload the PyPI package.
